...
> {
  ...
  _onClickNextDay = () => {
    const newMoment = moment(this.props.focusedMoment).add(1, 'day');
    this.props.onChangeFocusedMoment(newMoment);
  };

  _onClickPrevDay = () => {
    const newMoment = moment(this.props.focusedMoment).subtract(1, 'day');
    this.props.onChangeFocusedMoment(newMoment);
  };
  ...
  render() {
    ...
    const headerText = range.visibleStart.format('dddd, MMMM D, YYYY');
    ...
    return (
      <div className="calendar-view week-view day-view">
        ...
        >
          ...
          <HeaderControls
            title={headerText}
            nextAction={this._onClickNextDay}
            prevAction={this._onClickPrevDay}
